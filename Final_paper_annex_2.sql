...
База данных «Авиаперевозки» состоит из следующих таблиц:
•	bookings – бронирования
•	tickets – билеты
•	ticket_flights – билеты_рейсы
•	flights – рейсы
•	airports – аэропорты
•	aircrafts – самолеты
•	seats – посадочные места
•	boarding_passes – посадочные талоны
База данных «Авиаперевозки» состоит из следующих представлений:
•	flights_v – расширенная информация о рейсах
